    ...
    <div className="space-y-4 sm:space-y-6 p-4 sm:p-0">
      ...
      <div className="bg-white rounded-xl p-4 sm:p-6 shadow-sm border border-gray-100 flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        {/* <button 
          ...
          className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-[#275681] to-[#4F94D4] text-white rounded-lg hover:opacity-90 transition-colors font-medium text-sm shadow-lg shadow-blue-900/10"
        >
                  ...
                  <td className="px-6 py-4 text-right">
                    <div className="flex items-center justify-end gap-2">
                      <button 
                        ...
                        className="p-1.5 text-gray-400 hover:text-[#275681] hover:bg-blue-50 rounded-lg transition-all"
                        title="Copy Key"
                      >
                        {copiedId === apiKey.id ? (
        ...
        {apiKeys.map((apiKey) => (
          <div key={apiKey.id} className="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
            ...
            <div className="flex items-center gap-2 pt-3 border-t border-gray-100">
              <button 
                onClick={() => copyToClipboard(apiKey.id, apiKey.key)}
                className="flex-1 flex items-center justify-center gap-2 py-2 px-3 text-sm text-gray-600 hover:text-[#275681] hover:bg-blue-50 rounded-lg transition-all border border-gray-200"
              >
                {copiedId === apiKey.id ? (
                  <>
