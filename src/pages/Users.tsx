        ...
        <div className="p-6 space-y-6">
          ...
          <div className="flex items-center justify-between py-3">
            ...
            <button
              ...
              className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                localDisabled ? 'bg-[#275681]' : 'bg-gray-300'
              }`}
            >
              <span
          ...
          <div className="flex items-center justify-between py-3">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-[#275681] to-[#4F94D4] hover:opacity-90 text-white rounded-lg font-semibold text-sm transition-all"
            >
              <TrashIcon className="w-4 h-4" />
              <span>Delete</span>
            </button>
          ...
          <div className="flex gap-2 overflow-x-auto pb-2 sm:pb-0">
            <button
              ...
              className={`px-4 sm:px-6 py-2 sm:py-2.5 rounded-lg font-semibold text-xs sm:text-sm whitespace-nowrap transition-all ${
                activeTab === 'all' ? 'bg-gradient-to-r from-[#275681] to-[#4F94D4] text-white shadow-md' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
              }`}
            >
              All
            </button>
            <button
              ...
              className={`px-4 sm:px-6 py-2 sm:py-2.5 rounded-lg font-semibold text-xs sm:text-sm whitespace-nowrap transition-all ${
                activeTab === 'free' ? 'bg-gradient-to-r from-[#275681] to-[#4F94D4] text-white shadow-md' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
              }`}
            >
              Free
            </button>
            <button
              ...
              className={`px-4 sm:px-6 py-2 sm:py-2.5 rounded-lg font-semibold text-xs sm:text-sm whitespace-nowrap transition-all ${
                activeTab === 'subscribers' ? 'bg-gradient-to-r from-[#275681] to-[#4F94D4] text-white shadow-md' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
              }`}
            >
              Subscribers
            </button>
