        ...
        <div className="p-6">
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="flex-1 px-6 py-3 bg-gradient-to-r from-[#275681] to-[#4F94D4] text-white rounded-lg font-semibold hover:opacity-90 transition-all text-sm flex items-center justify-center gap-2"
            >
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#275681] focus:border-[#275681] transition-all text-sm"
              required
            />
          </div>
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#275681] focus:border-[#275681] transition-all bg-white text-sm"
            >
              <option>Admin</option>
          ...
          <div className="flex gap-3 pt-4">
            ...
            <button
              type="submit"
              className="flex-1 px-6 py-3 bg-gradient-to-r from-[#275681] to-[#4F94D4] text-white rounded-lg font-semibold hover:opacity-90 transition-all text-sm"
            >
              Create
            </button>
          </div>
      ...
      <div className="bg-white rounded-xl md:rounded-2xl shadow-sm overflow-hidden">
        ...
        <div className="p-3 sm:p-4 md:p-6 border-b border-gray-100">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2.5 bg-gradient-to-r from-[#275681] to-[#4F94D4] text-white rounded-lg font-semibold text-xs sm:text-sm hover:opacity-90 transition-all whitespace-nowrap"
          >
                  ...
                  <td className="px-6 py-4 text-center">
                    <div className="flex items-center justify-center gap-2">
                      <button
                        ...
                        className="inline-flex items-center justify-center w-10 h-10 bg-gradient-to-r from-[#275681] to-[#4F94D4] hover:opacity-90 text-white rounded-lg transition-colors"
                      >
            ...
            <div key={index} className="bg-white border-b border-gray-100 last:border-b-0">
              <div className="p-4 flex items-start justify-between gap-3">
                ...
                <div className="flex flex-col gap-2 flex-shrink-0">
                  <button
                    onClick={() => handleEditAdmin(admin)}
                    className="inline-flex items-center justify-center w-9 h-9 bg-gradient-to-r from-[#275681] to-[#4F94D4] hover:opacity-90 text-white rounded-lg transition-colors"
              ...
              {getPageNumbers().map((page, index) => (
                <button
                  ...
                  className={`min-w-[32px] px-2 py-1.5 rounded-lg font-semibold text-xs transition-all ${
                    page === currentPage ? 'bg-gradient-to-r from-[#275681] to-[#4F94D4] text-white shadow-md border border-[#275681]' 
