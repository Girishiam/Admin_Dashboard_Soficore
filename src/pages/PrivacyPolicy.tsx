    ...
    <div className="w-full min-h-screen relative" style={{ backgroundColor: '#E6EEEC' }}>
      ...
      <div className="max-w-5xl mx-auto px-6 sm:px-8 md:px-12 lg:px-16 py-8 sm:py-12">
        ...
        <div className="text-center mb-8 sm:mb-12">
          ...
          >
            <img src={logo} alt="Soul Gate Logo" className="w-10 h-10 object-contain" />
            <span className="font-bold text-lg" style={{ color: '#C59E54' }}>Soul Gate</span>
          </button>
          ...
          <div className="mb-4 p-3 bg-white rounded-lg shadow-sm border border-gray-200">
            <div className="flex gap-2 flex-wrap items-center">
              ...
              <div className="ml-auto">
                <button
                  onClick={handleSave}
                  className="px-4 py-2 bg-gradient-to-r from-[#275681] to-[#4F94D4] text-white rounded-lg font-semibold text-sm hover:opacity-90 transition-all"
                >
                  Save Changes
                </button>
              </div>
