        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#275681] focus:border-[#275681] text-sm font-mono"
          ...
          <div className="pt-2 flex gap-3">
            ...
            <button
              type="submit"
              className="flex-1 px-6 py-3 bg-gradient-to-r from-[#275681] to-[#4F94D4] text-white rounded-lg font-semibold hover:opacity-90 transition-all text-sm shadow-lg shadow-blue-900/10"
            >
              Save Changes
            </button>
          </div>
