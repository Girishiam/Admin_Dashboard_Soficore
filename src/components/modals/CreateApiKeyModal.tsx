        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-teal-50 rounded-lg">
              <KeyIcon className="w-6 h-6 text-[#275681]" />
            </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#275681] focus:border-[#275681] text-sm"
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#275681] focus:border-[#275681] text-sm bg-white"
            >
              ...
              {['read', 'write', 'admin'].map((scope) => (
                <label key={scope} className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    className="w-4 h-4 text-[#275681] border-gray-300 rounded focus:ring-[#275681]"
                  />
          ...
          <div className="pt-2">
            <button
              type="submit"
              className="w-full px-6 py-3 bg-gradient-to-r from-[#275681] to-[#4F94D4] text-white rounded-lg font-semibold hover:opacity-90 transition-all text-sm shadow-lg shadow-blue-900/10"
            >
              Generate Key
            </button>
          </div>
